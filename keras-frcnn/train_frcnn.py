...
# set the name for weight and config file
...
if options.network == 'vgg':
	...
	C.network = 'resnet50'
elif options.network == 'alexnet3':
	from keras_frcnn import alexnet3 as nn
	C.network = 'alexnet3'
else:
...
for epoch_num in range(num_epochs):
	...
	while True:
		try:
			...
			if C.num_rois > 1:
			    # 默认的正负例训练比例为1:2, 其实对于医学检测来说并不合适
			    # default pos-neg ratio is 1:2, the ratio will be changed when there is not enough pos example
